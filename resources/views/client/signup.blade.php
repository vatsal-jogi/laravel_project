      ...
      <div class="card-body py-5 px-md-5">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-lg-8">
            ...
            <form action="{{route('store.sign')}}" method="post">
                @csrf
              <!-- 2 column grid layout with text inputs for the first and last names -->
              <div class="row">
                <div class="col-md-6 mb-4">
                  <div class="form-outline">
                    <input type="text" id="form3Example1" name="firstname" class="form-control" placeholder="First name"/>
                    @error('firstname')
              ...
              <div class="form-outline mb-4">
                <input type="password" id="form3Example4" class="form-control" name="repeatpass" placeholder=" Repeat Password"/>
